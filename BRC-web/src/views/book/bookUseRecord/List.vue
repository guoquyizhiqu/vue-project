        ...
        <el-row>
            <el-col :span="24">
                ...
                >
                    ...
                    <el-table-column prop="bookName" label="借用时间" sortable width="180"></el-table-column>
                    <el-table-column prop="bookName" label="归还时间" sortable width="180"></el-table-column>
...
<script>
    ...
    import  { bookUseRecords } from '../../../module/book/bookUseRecord';
